...
//	unsigned char serie;
//};
//typedef struct StructuraMasina Masina;  //alias pentru StructuraMasina
//
...
//	m1.id = atoi(aux);
//	m1.nrUsi = atoi(strtok(NULL, sep));//pun NULL ca sa reia cautarea de unde a ramas
...
//	Masina* masini = NULL;
//	int nrMasini = 0;
//	masini=citireVectorMasiniFisier("sem.txt", &nrMasini);
